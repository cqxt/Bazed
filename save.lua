...
local SaveManager = {} do
	SaveManager.Folder = getgenv().settings_folder or "BazedSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
	...
	function SaveManager:BuildConfigSection(tab,disablecloudconfigs)
		...
		if not disablecloudconfigs then
			...
			local BrowserLIB = loadstring(game:HttpGet("https://raw.githubusercontent.com/laagginq/Bazed/main/browserv2.lua"))()
